...
while (TRUE)
{
  ...
  if (length(games_new$Game > 0)){
    ...
    webhook = str_conv(readLines("C:/Users/jacob/Desktop/Bet Scraping/webhook.txt"), "utf-8")
    webhook1 = str_conv(readLines("C:/Users/jacob/Desktop/Bet Scraping/webhook-1.txt"), "utf-8")
